...
public class MealAdapter extends RecyclerView.Adapter<MealAdapter.MealViewHolder> {
    ...
    public MealAdapter(Context context, List<MealEntity> modelList) {
    ...
    public class MealViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            MealEntity mealEntity = modelList.get(position);
            mealEntity.setUserId(FirebaseAuth.getInstance().getUid());

            Intent intent = new Intent(context.getApplicationContext(), DetailActivity.class);
            intent.putExtra(MEAL_ADAPTER_TO_DETAIL_ACTIVITY, mealEntity);
