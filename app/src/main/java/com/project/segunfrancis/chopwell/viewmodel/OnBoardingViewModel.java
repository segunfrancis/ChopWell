package com.project.segunfrancis.chopwell.viewmodel;
...
public class OnBoardingViewModel extends ViewModel {
    public enum UserStates {SEEN_ON_BOARDING_SCREEN, NOT_SEEN_ON_BOARDING_SCREEN}

    public MutableLiveData<UserStates> mUserStatesMutableLiveData = new MutableLiveData<>();
